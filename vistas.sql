...
select cod_socio, nombre, apellido1, apellido2, email,
...
create view devoluciones_tarde (cod_libro, titulo, cod_socio, nombre, apellido1, apellido2, email, telefono, tiempo_retrasado) as
